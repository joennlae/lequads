var levelSelector = cc.Layer.extend({
    ...
    init: function() {
        ...
        var controlRightLabel = new cc.MenuItemSprite(this.controlRight, this.controlRightP, this.controllingRight, this);
        ...
        var controlLeftLabel = new cc.MenuItemSprite(this.controlLeft, this.controlLeftP, this.controllingLeft, this);
        ...
        var backItemLabel = new cc.MenuItemSprite(this.backLabel, this.backLabelP, this.onBack, this);
    ...
    onTouchEnded: function(touch, event) {
        ...
        switch (rtn) {
            ...
            default:
                ...
                if (this.levelNum.value <= levelsArray.length);
                if (corX > this.winsize.width / 4 && corX < this.winsize.width / 4 * 3 && corY > this.winsize.height / 4 && corY < this.winsize.height / 4 * 3)
                    if (this.levelNum.value <= levelsArray.length) this.onPlay();
                break;
        }
    },
    onExit: function() {
